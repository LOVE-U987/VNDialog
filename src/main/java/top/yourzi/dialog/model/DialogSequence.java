...
public class DialogSequence {
    ...
    /**
     * 获取对话序列的第一个对话条目。
     * @return 第一个对话条目；如果序列为空或未定义起始 ID 且无条目，则返回 null。
     */
     ...
     * @return 下一个对话条目；如果没有下一个条目，则返回 null。
     */
